...
> **Operative near-term plan (2026-09-02):** after the PM's first playtest, the next three work sets are laid out in [`08-three-updates.md`](08-three-updates.md) — **Update 1 FAIR PLAY** (finishes M2's exit test: guidance, a real perception model, honesty), **Update 2 PLASTIC** (M1 proper + the graphics pass), **Update 3 OPEN THE HOUSE** (M3: campaign frame, Sandbox, Kitchen, water spike). The exit tests below still apply; 08 says what gets built to pass them.
