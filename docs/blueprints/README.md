...
| 2 | The Backyard | `map-02-backyard.md` | **built** — `src/maps/defs/backyard.ts`; P1 (`tools/walk.mjs`) + P2/P3 (`tools/combat.mjs`, `tools/mission.mjs`) gated headless; P4 dressing partial; P6 awaits a human — **M2 slice** |
