...
- **Fireplace.** The hearth is 3 u tall (a real raised hearth), so a stack of old magazines at (47.75, 0, 14) gets you onto it from the west. The stone ledges come out of the south cheek's outer face 5.2 deep and **zig-zag** front → back → front (6 + 6 + 3 ledges, x 49.4..59 at z ≈ 22.6 — the breast's last 1.6 u sit inside the garage wall), the top one at 21.0, one auto-step under the mantel (21.2). Each ledge is a 1.2-thick slab collider, not a column from the floor, because the return pass hangs directly over the first. The contract's ledges wrapped from the back straight to the front — an 11 u leap. The mantel walkway in front of the chimney breast is 1.5 u wide (8 cm — a real mantel).
