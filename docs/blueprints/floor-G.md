...
- **Fireplace.** The hearth is 3 u tall (a real raised hearth), so a stack of old magazines at (47.75, 0, 14) gets you onto it from the west. The stone ledges come out of the south cheek's outer face 5.2 deep and **zig-zag** front → back → front (7 + 7 + 4 ledges, **1.0 risers** on 1.25 treads, x 48.5..58.5 at z ≈ 22.6 — the breast's last 1.6 u sit inside the garage wall), the top one at 21.0, one auto-step under the mantel (21.2). Each pass turns two treads back so every slab keeps 2 u of head room under the one above; each ledge is a 1.0-thick, 1.2-long slab collider (shorter than the tread, so neighbours never overlap and no stone hangs one unit over the one beside it), not a column from the floor. The contract's 1.2 risers left 0.15 u under the jump apex and made fifteen hops in a row a coin toss. The contract's ledges wrapped from the back straight to the front — an 11 u leap. The mantel walkway in front of the chimney breast is 1.5 u wide (8 cm — a real mantel).
