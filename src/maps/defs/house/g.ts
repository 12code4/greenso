...
export const FLOOR_G: MapDef = {
  ...
  routes: [
    ...
    { id: 'RT_fireplace', class: 'climb', points: [[30,0,5], [43,0,14], [52,3,14], [51.0,4.1,22.6], [52.25,5.2,22.6], [53.5,6.3,22.6], [54.75,7.4,22.6], [56.0,8.5,22.6], [57.25,9.6,22.6], [58.5,10.7,22.6], [57.25,11.8,22.6], [56.0,12.9,22.6], [54.75,14.0,22.6], [53.5,15.1,22.6], [52.25,16.2,22.6], [51.0,17.3,22.6], [49.75,18.4,22.6], [51.0,19.5,22.6], [52.25,20.6,22.6], [52.5,21.2,20.3], [52.3,21.2,12], [52.3,21.2,6]] }, // one waypoint per stone (7 up, 7 back, 2 up), then the mantel's corner
