...
export const FLOOR_G: MapDef = {
  ...
  routes: [
    ...
    { id: 'RT_fireplace', class: 'climb', points: [[30,0,5], [43,0,14], [52,3,14], [48.5,4.1,22.6], [49.75,5.2,22.6], [51.0,6.3,22.6], [52.25,7.4,22.6], [53.5,8.5,22.6], [54.75,9.6,22.6], [56.0,10.7,22.6], [57.25,11.8,22.6], [58.5,12.9,22.6], [57.25,14.0,22.6], [56.0,15.1,22.6], [54.75,16.2,22.6], [53.5,17.3,22.6], [52.25,18.4,22.6], [51.0,19.5,22.6], [49.75,20.6,22.6], [50.2,20.6,21.6], [52.0,21.2,20.0], [52.3,21.2,12], [52.3,21.2,6]] }, // one waypoint per stone (9 up, 7 back), then the mantel corner
    { id: 'RT_bookcase', class: 'climb', points: [[-30, 0, 50], [-50, 0, 45], [-54.7, 0.7, 46], [-54.7, 5.1, 61], [-54.7, 6.2, 58.8], [-54.7, 10.6, 39], [-54.7, 11.7, 41.2], [-54.7, 16.1, 61], [-54.7, 17.2, 58.8], [-54.7, 21.6, 39], [-54.7, 22.7, 41.2], [-54.7, 27.1, 61], [-54.7, 28.2, 58.8], [-54.7, 32.6, 39], [-54.7, 33.7, 41.2], [-54.7, 35.9, 61], [-56, 37, 58.8], [-56, 37, 48]] }, // front lane: the tallest stack's edge, then the board above, shelf by shelf
