...
export const FLOOR_G: MapDef = {
  ...
  routes: [
    ...
    { id: 'RT_fireplace', class: 'climb', points: [[30,0,5], [43,0,14], [52,3,14], [51.0,4.2,22.6], [52.6,5.4,22.6], [54.2,6.6,22.6], [55.8,7.8,22.6], [57.4,9.0,22.6], [59.0,10.2,22.6], [57.4,11.4,22.6], [55.8,12.6,22.6], [54.2,13.8,22.6], [52.6,15.0,22.6], [51.0,16.2,22.6], [49.4,17.4,22.6], [51.0,18.6,22.6], [52.6,19.8,22.6], [54.2,21.0,22.6], [52.3,21.2,12], [52.3,21.2,6]] }, // one waypoint per ledge (6 + 6 + 3), walked not sprinted
    { id: 'RT_bookcase', class: 'climb', points: [[-30, 0, 50], [-50, 0, 45], [-54.7, 0.7, 46], [-54.7, 5.1, 61], [-54.7, 6.2, 58.8], [-54.7, 10.6, 39], [-54.7, 11.7, 41.2], [-54.7, 16.1, 61], [-54.7, 17.2, 58.8], [-54.7, 21.6, 39], [-54.7, 22.7, 41.2], [-54.7, 27.1, 61], [-54.7, 28.2, 58.8], [-54.7, 35.9, 39], [-56, 37, 41.2], [-56, 37, 48]] }, // front lane: the tallest stack's edge (so the hop through the gap is proactive, < 2.6 u), then the board above
