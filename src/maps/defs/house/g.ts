...
export const FLOOR_G: MapDef = {
  ...
  routes: [
    ...
    { id: 'RT_fireplace', class: 'climb', points: [[30,0,5], [43,0,14], [52,3,14], [51.0,4.0,22.6], [52.25,5.0,22.6], [53.5,6.0,22.6], [54.75,7.0,22.6], [56.0,8.0,22.6], [57.25,9.0,22.6], [58.5,10.0,22.6], [56.0,11.0,22.6], [54.75,12.0,22.6], [53.5,13.0,22.6], [52.25,14.0,22.6], [51.0,15.0,22.6], [49.75,16.0,22.6], [48.5,17.0,22.6], [51.0,18.0,22.6], [52.25,19.0,22.6], [53.5,20.0,22.6], [54.75,21.0,22.6], [52.3,21.2,12], [52.3,21.2,6]] }, // one waypoint per ledge (7 + 7 + 4), walked not sprinted
