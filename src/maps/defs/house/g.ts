...
export const FLOOR_G: MapDef = {
  ...
  routes: [
    ...
    { id: 'RT_fireplace', class: 'climb', points: [[30,0,5], [43,0,14], [52,3,14], [51.0,4.1,20.0], [52.1,5.2,20.0], [53.2,6.3,20.0], [54.3,7.4,20.0], [55.4,8.5,20.0], [56.5,9.6,20.0], [57.6,10.7,20.0], [58.7,11.8,20.0], [58.7,12.9,22.0], [57.6,14.0,22.0], [56.5,15.1,22.0], [55.4,16.2,22.0], [54.3,17.3,22.0], [53.2,18.4,22.0], [52.1,19.5,22.0], [51.0,20.6,22.0], [52.3,21.2,20.0], [52.3,21.2,12], [52.3,21.2,6]] }, // one waypoint per stone (8 up the inner row, 8 back along the outer), then the mantel
